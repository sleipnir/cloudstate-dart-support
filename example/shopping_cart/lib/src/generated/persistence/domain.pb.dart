...
class LineItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LineItem',
      package: const $pb.PackageName('com.example.shoppingcart.persistence'),
...
class ItemAdded extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ItemAdded',
      package: const $pb.PackageName('com.example.shoppingcart.persistence'),
      createEmptyInstance: create)
  ...
  factory ItemAdded.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ItemAdded.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ItemAdded clone() => ItemAdded()..mergeFromMessage(this);
  ItemAdded copyWith(void Function(ItemAdded) updates) =>
      super.copyWith((message) => updates(message as ItemAdded));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ItemAdded getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ItemAdded>(create);
...
class ItemRemoved extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ItemRemoved',
      package: const $pb.PackageName('com.example.shoppingcart.persistence'),
      createEmptyInstance: create)
    ..aOS(1, 'productId', protoName: 'productId')
    ..hasRequiredFields = false;
  ...
  factory ItemRemoved.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ItemRemoved.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ItemRemoved clone() => ItemRemoved()..mergeFromMessage(this);
  ItemRemoved copyWith(void Function(ItemRemoved) updates) =>
      super.copyWith((message) => updates(message as ItemRemoved));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ItemRemoved getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ItemRemoved>(create);
