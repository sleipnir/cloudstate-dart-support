...
class Eventing extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Eventing', package: const $pb.PackageName('cloudstate'), createEmptyInstance: create)
    ..aOS(1, 'in')
    ..aOS(2, 'out')
  ...
  Eventing copyWith(void Function(Eventing) updates) => super.copyWith((message) => updates(message as Eventing));
...
class EventingExt {
  static final $pb.Extension eventing = $pb.Extension<Eventing>('google.protobuf.MethodOptions', 'eventing', 50003, $pb.PbFieldType.OM, defaultOrMaker: Eventing.getDefault, subBuilder: Eventing.create);
