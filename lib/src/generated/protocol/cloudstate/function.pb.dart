...
class FunctionCommand extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FunctionCommand',
      package: const $pb.PackageName('cloudstate.function'),
  ...
  factory FunctionCommand.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory FunctionCommand.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  FunctionCommand clone() => FunctionCommand()..mergeFromMessage(this);
  FunctionCommand copyWith(void Function(FunctionCommand) updates) =>
      super.copyWith((message) => updates(message as FunctionCommand));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static FunctionCommand create() => FunctionCommand._();
  FunctionCommand createEmptyInstance() => create();
  static $pb.PbList<FunctionCommand> createRepeated() =>
      $pb.PbList<FunctionCommand>();
  @$core.pragma('dart2js:noInline')
  static FunctionCommand getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<FunctionCommand>(create);
...
enum FunctionReply_Response { failure, reply, forward, notSet }

class FunctionReply extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, FunctionReply_Response>
      _FunctionReply_ResponseByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FunctionReply',
      package: const $pb.PackageName('cloudstate.function'),
      createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
  ...
  factory FunctionReply.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory FunctionReply.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  FunctionReply clone() => FunctionReply()..mergeFromMessage(this);
  FunctionReply copyWith(void Function(FunctionReply) updates) =>
      super.copyWith((message) => updates(message as FunctionReply));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static FunctionReply create() => FunctionReply._();
  FunctionReply createEmptyInstance() => create();
  static $pb.PbList<FunctionReply> createRepeated() =>
      $pb.PbList<FunctionReply>();
  @$core.pragma('dart2js:noInline')
  static FunctionReply getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<FunctionReply>(create);
  static FunctionReply _defaultInstance;

  FunctionReply_Response whichResponse() =>
      _FunctionReply_ResponseByTag[$_whichOneof(0)];
