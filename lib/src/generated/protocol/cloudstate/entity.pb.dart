...
class Reply extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Reply', package: const $pb.PackageName('cloudstate'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(1)
  set payload($5.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class Forward extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Forward', package: const $pb.PackageName('cloudstate'), createEmptyInstance: create)
    ..aOS(1, 'serviceName')
    ..aOS(2, 'commandName')
  ...
  factory Forward.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Forward.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  Forward clone() => Forward()..mergeFromMessage(this);
  Forward copyWith(void Function(Forward) updates) => super.copyWith((message) => updates(message as Forward));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static Forward getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Forward>(create);
  ...
  @$pb.TagNumber(3)
  set payload($5.Any v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class ClientAction extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, ClientAction_Action> _ClientAction_ActionByTag = {
    1 : ClientAction_Action.reply,
    2 : ClientAction_Action.forward,
    3 : ClientAction_Action.failure,
    0 : ClientAction_Action.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClientAction', package: const $pb.PackageName('cloudstate'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
  ...
  ClientAction copyWith(void Function(ClientAction) updates) => super.copyWith((message) => updates(message as ClientAction));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  ClientAction_Action whichAction() => _ClientAction_ActionByTag[$_whichOneof(0)];
  ...
  @$pb.TagNumber(2)
  set forward(Forward v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set failure(Failure v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class SideEffect extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SideEffect', package: const $pb.PackageName('cloudstate'), createEmptyInstance: create)
    ..aOS(1, 'serviceName')
    ..aOS(2, 'commandName')
    ..aOM<$5.Any>(3, 'payload', subBuilder: $5.Any.create)
    ..aOB(4, 'synchronous')
  ...
  factory SideEffect.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SideEffect.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  SideEffect clone() => SideEffect()..mergeFromMessage(this);
  SideEffect copyWith(void Function(SideEffect) updates) => super.copyWith((message) => updates(message as SideEffect));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static SideEffect getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SideEffect>(create);
  ...
  @$pb.TagNumber(4)
  set synchronous($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
...
class Command extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Command', package: const $pb.PackageName('cloudstate'), createEmptyInstance: create)
    ..aOS(1, 'entityId')
    ..aInt64(2, 'id')
    ..aOS(3, 'name')
...
class StreamCancelled extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamCancelled', package: const $pb.PackageName('cloudstate'), createEmptyInstance: create)
    ..aOS(1, 'entityId')
    ..aInt64(2, 'id')
    ..hasRequiredFields = false
  ;
  ...
  factory StreamCancelled.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory StreamCancelled.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  StreamCancelled clone() => StreamCancelled()..mergeFromMessage(this);
  StreamCancelled copyWith(void Function(StreamCancelled) updates) => super.copyWith((message) => updates(message as StreamCancelled));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static StreamCancelled create() => StreamCancelled._();
  StreamCancelled createEmptyInstance() => create();
  static $pb.PbList<StreamCancelled> createRepeated() => $pb.PbList<StreamCancelled>();
  @$core.pragma('dart2js:noInline')
  static StreamCancelled getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<StreamCancelled>(create);
...
class Failure extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Failure', package: const $pb.PackageName('cloudstate'), createEmptyInstance: create)
    ..aInt64(1, 'commandId')
    ..aOS(2, 'description')
    ..hasRequiredFields = false
  ;
...
class EntitySpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EntitySpec', package: const $pb.PackageName('cloudstate'), createEmptyInstance: create)
  ...
  factory EntitySpec.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EntitySpec.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  EntitySpec clone() => EntitySpec()..mergeFromMessage(this);
  EntitySpec copyWith(void Function(EntitySpec) updates) => super.copyWith((message) => updates(message as EntitySpec));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static EntitySpec getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EntitySpec>(create);
  static EntitySpec _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<$core.int> get proto => $_getN(0);
  @$pb.TagNumber(1)
  set proto($core.List<$core.int> v) { $_setBytes(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set serviceInfo(ServiceInfo v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class ServiceInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ServiceInfo', package: const $pb.PackageName('cloudstate'), createEmptyInstance: create)
    ..aOS(1, 'serviceName')
  ...
  @$pb.TagNumber(2)
  set serviceVersion($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set serviceRuntime($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set supportLibraryName($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set supportLibraryVersion($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
...
class Entity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Entity', package: const $pb.PackageName('cloudstate'), createEmptyInstance: create)
    ..aOS(1, 'entityType')
    ..aOS(2, 'serviceName')
    ..aOS(3, 'persistenceId')
    ..hasRequiredFields = false
  ...
  @$pb.TagNumber(3)
  set persistenceId($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
...
class UserFunctionError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UserFunctionError', package: const $pb.PackageName('cloudstate'), createEmptyInstance: create)
    ..aOS(1, 'message')
    ..hasRequiredFields = false
  ;
  ...
  factory UserFunctionError.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UserFunctionError.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  UserFunctionError clone() => UserFunctionError()..mergeFromMessage(this);
  UserFunctionError copyWith(void Function(UserFunctionError) updates) => super.copyWith((message) => updates(message as UserFunctionError));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UserFunctionError create() => UserFunctionError._();
  UserFunctionError createEmptyInstance() => create();
  static $pb.PbList<UserFunctionError> createRepeated() => $pb.PbList<UserFunctionError>();
  @$core.pragma('dart2js:noInline')
  static UserFunctionError getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserFunctionError>(create);
...
class ProxyInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ProxyInfo', package: const $pb.PackageName('cloudstate'), createEmptyInstance: create)
  ...
  factory ProxyInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ProxyInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ProxyInfo clone() => ProxyInfo()..mergeFromMessage(this);
  ProxyInfo copyWith(void Function(ProxyInfo) updates) => super.copyWith((message) => updates(message as ProxyInfo));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set protocolMajorVersion($core.int v) { $_setSignedInt32(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set protocolMinorVersion($core.int v) { $_setSignedInt32(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set proxyName($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set proxyVersion($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
