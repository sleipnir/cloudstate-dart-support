...
class CrdtWriteConsistency extends $pb.ProtobufEnum {
  ...
  static const CrdtWriteConsistency MAJORITY =
      CrdtWriteConsistency._(1, 'MAJORITY');
  ...
  static final $core.Map<$core.int, CrdtWriteConsistency> _byValue =
...
class CrdtClock extends $pb.ProtobufEnum {
  ...
  static const CrdtClock CUSTOM_AUTO_INCREMENT =
      CrdtClock._(3, 'CUSTOM_AUTO_INCREMENT');
  ...
  static final $core.Map<$core.int, CrdtClock> _byValue =
      $pb.ProtobufEnum.initByValue(values);
